...
// Manipulação do DOM utilizando jQuery
...
function consultarPostsComJQuery() {
  $.getJSON(apiUrl + "/blog", (dados) => carregarResumoPostComJQuery(dados,indiceInicio,quantidade));
}

$(document).ready(function () {
  $("#load-more").click(function () {
  consultarPostsComJQuery(indicePost, 3); // o primeiro argumento indica o índice do primeiro post; o segundo argumento é a quantidade de posts a serem carregados.
  });
